...
$current_task_img = get_task_img($GLOBALS['current_task'], $GLOBALS['user']);
...
if ($user_customer) {
    ...
    $csrf = get_customer_task_csrf($GLOBALS['user'][ID], $GLOBALS['current_task'][ID]);
    ...
    $csrf = get_performer_task_csrf($GLOBALS['user'][ID], $GLOBALS['current_task'][ID]);
} else {
...
<li class="task-feed-item media<?php echo $task_class . $task_unpaid_marker; ?>" data-id="<?php echo $current_task_id ?>">
    ...
    <div class="row media-body task-item">
        ...
        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 pull-right">
            ...
            <?php if (is_performer($GLOBALS['user'][ROLE])) {
    ...
    <?php if (is_customer($GLOBALS['user'][ROLE])) {
